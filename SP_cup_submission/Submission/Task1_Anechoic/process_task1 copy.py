...
Generates Task1_Anechoic_5dB.mat (SP Cup compliant)
"""
...
MODEL_PATH = os.path.join(MODEL_DIR, "anechoic_Conformer.pth")
OUT_MAT = os.path.join(THIS_DIR, "Task1_Anechoic_5dB.mat")
...
print("===================================")
print("Task 1 Anechoic processing done.")
